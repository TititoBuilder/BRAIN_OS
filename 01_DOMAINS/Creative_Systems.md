...
A closing segment appended to every audio chapter.
- Voice: `am_michael` (deep male, Kokoro) after `af_heart` main content
- Generated by Claude API from chapter source text
- Structure: 3 key concepts + real-world analogies + one closing line
- Opens: "Let me bring this home for you..."
- Purpose: knowledge consolidation at end of every lesson
- Status: OPERATIONAL — `anchor_generator.py` deployed 2026-05-23
- Tool: [[anchor_generator.py]] at `C:\BRAIN_OS\09_TOOLS\anchor_generator.py`
- Links: [[CA_Kokoro_TTS]] [[brain-audio]] [[BDF_Book_System]] [[CA_Book_System]]
