...
- [x] CC_Nav.md exists twice and diverged: 00_NAV (1473 bytes) vs 02_PROJECTS (1364). Pick canonical, delete the other. Then check BDF_Nav, CA_Nav, OBS_Nav, ReadAlong_Nav, ResolveMCP_Nav for the same split. RESOLVED 2026-08-19 (commit 49d39e0) — this item was stale here; the fix already landed same day it was found, verified via git log during the 2026-09-11 vault_integrity design pass.
